...
const provisionTelephonyViews = {
    ...
    selectTelephony() {
        ...
        `
          <div style="text-align: center !important;">
            <button type="button" id="btnTwillio" class="btn btn-success-modified" data-dismiss="modal" data-toggle="modal">    
              <a href="#"> Twillio </a>
            </button>
            <button type="button" id="btnNexmo" class="btn btn-success-modified" data-dismiss="modal" data-toggle="modal">
              <a href="#"> Nexmo </a>
            </button>
          </div>
        `; 
    ...
    displayProvisioningModal() {
        ...
        `        
          <p>
            We will be provisioning the following items:<br>
            Create a Location<br>
            Create a Site<br>
            Create a BYOC SIP Trunk to Twilio
          </p>
        `
    ...
    displaySipTrunkModal() {
        ...
        `
          ...
          <div style="width:50%; float:right; padding:5px 10px;">
            <div class="form-group-inline">
              <div style="align-items: initial; display: flex;">
